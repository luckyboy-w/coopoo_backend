      ...
      <div class="ly-table-panel">
        <div class="ly-data-list">
          <el-table
            ...
            <el-table-column prop="serviceContent" label="门店服务介绍" width="520px">
                <template slot-scope="scope">
                    <p v-html="scope.row.serviceContent"/>
                </template>
            </el-table-column>
            <el-table-column prop="userCnt" label="已兑换人数" width="120px"></el-table-column>
            <el-table-column prop="beanNum" label="已兑换靠谱豆" width="120px"></el-table-column>
