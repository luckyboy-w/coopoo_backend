<template>
	<div>
			...
			<div class="ly-table-panel">
				<div class="ly-data-list">
					...
					>
						...
						<el-table-column prop="activityName" label="活动名称" width="300px"></el-table-column>
						...
						<el-table-column prop="activityCost" label="报名靠谱豆" width="130px"></el-table-column>
						<el-table-column prop="actPerson" label="报名人数" width="100px"></el-table-column>
						<el-table-column prop="actBean" label="已兑换靠谱豆" width="150px"></el-table-column>
		...
		<activityList v-if="showActList" @showListPanel="showListPanel" :actData="actData"></activityList>
	</div>
</template>
...
export default {
	...
	components: { saveOrEdit ,activityList},
	created() {},
	data() {
		return {
			actData:{},
