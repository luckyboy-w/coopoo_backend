<template>
  <div class="update-form-panel">
    <el-form ref="dataForm" :model="dataForm" :rules="rules" label-width="140px" width="1000px">
      ...
      <el-select v-model="dataForm.useWay" :disabled="disabled||disabled_" placeholder="请选择">
      ...
      <el-form-item prop="faceValue" label="抵用额：">
        <el-input style="width:260px"  oninput="value=value.replace(/[^0-9.]/g,'')" :disabled="disabled||disabled_"  v-model="dataForm.faceValue"  placeholder="请输入"/>
      </el-form-item>
      ...
      <el-select v-model="dataForm.validType" :disabled="disabled||disabled_" placeholder="请选择">
        <el-option label="有效期" :value="2" />
        <el-option label="截止时间" :value="1" />
      </el-select>
      </el-form-item>
      <el-form-item v-if="dataForm.validType=='2'" prop="validTime" label="有效期：">
        <el-input style="width:260px" type="number" oninput="this.value=this.value.replace(/\D/g,'')" :disabled="disabled||disabled_"  v-model="dataForm.validTime" />&nbsp;&nbsp; 天
      </el-form-item>
      <el-form-item v-if="dataForm.validType=='1'" prop="validityPeriod" label="截止时间：">
        <el-date-picker  style="width:260px" :disabled="disabled||disabled_"
      ...
      <el-select v-model="dataForm.useGoodsType" :disabled="disabled||disabled_" @change="changeUseGoodsType" placeholder="请选择">
        <el-option label="普通商城" :value="1" />
        <el-option label="专属商城" :value="2" />
      </el-select>
      </el-form-item>
      <el-form-item label="指定商品">
        <el-button type="success" :disabled="disabled||disabled_" @click="relatedGoods">指定商品</el-button>
      </el-form-item>
      <el-form-item>
