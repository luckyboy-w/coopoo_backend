			...
			<div class="ly-table-panel">
				<div class="ly-data-list">
					...
					>
						...
						<el-table-column prop="specValue" label="规格值" width="450px"></el-table-column>
...
export default {
	...
	methods: {
		deleteRow(rowData, data) {
			...
			postMethod("/backend/goodSpec/delete", param).then(res => {
				this.loadList();
				this.$message("删除成功");
			});
		},
		...
		loadList() {
			let scope = this;
			getMethod("/backend/goodSpec/findPage", this.searchParam).then(
				res => {
