			...
			<div class="ly-tool-panel">
				<table>
					<tr>
						<td>分类名称:</td>
						<td>
							<el-input v-model="searchParam.typeName" width="180px" />
						</td>
						<td>
			...
			<div class="ly-table-panel">
				<div class="ly-data-list">
					...
					>
						...
						<el-table-column prop="typeName" label="分类名称" width="300px">
							<template slot-scope="scope">
								<span>
									...
									<el-button
										...
										@click="addOrEdit('appendLevel',scope.$index,scope.row)"
										icon="el-icon-plus"
										circle
									></el-button>
								</span>
						...
						<el-table-column prop="typeLabel" label="标签名称" width="220px" />
						...
						<el-table-column prop="id" label="操作" width="200px">
							<template slot-scope="scope">
								<el-button
									type="text"
									size="small"
									@click.native.prevent="addOrEdit('edit',scope.$index, scope.row)"
								>编辑</el-button>
								<el-button
									type="text"
									size="small"
...
export default {
	...
	methods: {
		...
		addOrEdit(oper, rowIndex, rowData) {
			const scope = this;
			...
			if (oper == "edit") {
				...
				getMethod("/backend/goodType/findObject", param).then(res => {
		...
		loadList() {
			const scope = this;
			getMethod("/backend/goodType/findPage", this.searchParam).then(
				res => {
