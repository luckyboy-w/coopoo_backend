  ...
  <div class="update-form-panel">
    <el-form ref="dataForm" :model="dataForm" label-width="130px">
      ...
      <el-form-item label="服务商等级" required>
        <el-select v-model="dataForm.provinceRole" disabled="true"  @change="switchLevel">
          <el-option
      ...
      <el-form-item v-show="false" label="店主电话" required>
        <el-input v-model="dataForm.owerMobileNo"  disabled="true"   />
      </el-form-item>
      ...
      <el-form-item v-show="dataForm.provinceRole == 5" label="营业执照照片" required>
      ...
      <el-form-item label="文件协议" required>
        ...
        <ul class="el-upload-list el-upload-list--text">
          <li v-for="(item,index) in protocalFileList" :key="index" tabindex="0" class="el-upload-list__item is-success el-list-enter-to"><!---->
            ...
            <label class="el-upload-list__item-status-label"><i class="el-icon-upload-success el-icon-circle-check" @click="handleProtocalRemove(item)" /></label><i class="el-icon-close" v-if="false" @click="handleProtocalRemove(item)" />
          </li>
        </ul>
