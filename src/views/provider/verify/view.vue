  ...
  <div class="update-form-panel">
    <el-form ref="dataForm" :model="dataForm" label-width="130px">
      ...
      <el-form-item label="服务商等级" required>
        <el-select v-if="dataForm.provinceRole!='6'" v-model="dataForm.provinceRole" disabled="true" @change="switchLevel">
      ...
      <el-form-item v-if="dataForm.type=='2'" label="营业执照照片" required>
        ...
        <el-upload disabled="true" :action="uploadLicenseUrl" list-type="picture-card" :on-preview="handleLicensePreview"
	  ...
	  <el-form-item v-if="dataForm.type=='2'" label="银行开户许可照片">
	    ...
	    <el-upload disabled="true" :action="uploadBankLicenseUrl" list-type="picture-card" :on-preview="handleLicensePreview"
        ...
        <ul class="el-upload-list el-upload-list--text">
          <li v-for="(item,index) in protocalFileList" :key="index" tabindex="0" class="el-upload-list__item is-success el-list-enter-to">
            ...
            <label class="el-upload-list__item-status-label"><i class="el-icon-upload-success el-icon-circle-check"
                @click="handleProtocalRemove(item)" /></label><i class="el-icon-close" v-if="false" @click="handleProtocalRemove(item)" />
          </li>
        </ul>

      </el-form-item>
      <el-form-item v-if="dataForm.provinceRole!='6'" label="银行名称">
        <el-input v-model="dataForm.bankName" disabled="true" />
      </el-form-item>
      <el-form-item v-if="dataForm.provinceRole!='6'" label="银行卡号">
        <el-input v-model="dataForm.cardNo" disabled="true" />
      </el-form-item>
      <el-form-item v-if="dataForm.provinceRole!='6'" label="地区">
