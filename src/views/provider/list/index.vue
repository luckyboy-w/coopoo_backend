        ...
        <table>
          <tr>
            ...
            <td>
              ...
              <el-button icon="el-icon-search" @click="exportData()">导出</el-button>
            </td>
          </tr>
        </table>
      </div>
      <div class="ly-table-panel">
        <div class="ly-data-list">
          <el-table
            ...
            <el-table-column prop="invUserNum" label="发展会员总数" width="150px" />
            <el-table-column prop="totalFee" label="发展会员消费总数" width="150px" />
            <el-table-column prop="perPrice" label="提成金额" width="150px" />
            <el-table-column prop="beanNum" label="靠谱豆数量" width="150px" />
  ...
  methods: {
    ...
    loadprovinceRoleList() {
      ...
      getMethod('/backend/providerRole/findList', null).then(res => {
        ...
        for(let i = 0 ; i < scope.provinceRoleList.length ; i++){
          let row = scope.provinceRoleList[i]
          scope.providerMap[row.id] = row.providerLevel
        }
        scope.initLoad()
      })
    },
