  ...
  <div>
        ...
        <div class="ly-data-list">
          <el-table ref="mainTable" :data="tableData.list" style="width: 100%; margin-bottom: 20px;" row-key="orderId"
            ...
            <el-table-column prop="id" label="操作" width="250px">
              <template slot-scope="scope">
                <el-link v-if="scope.row.status == 10" type="primary" @click="sendOrd(scope.row)">
                  发货
                </el-link>
                <el-link v-if="scope.row.status == 10" type="primary" @click="cancelOrd(scope.row)">
                  取消订单
                </el-link>
    ...
    <el-dialog v-if="pushStock" title="补货">
      <el-form ref="dataForm" :model="stockForm" label-width="100px">
        ...
        <el-form-item>
          <el-button type="primary" @click="submitStock()">
            提交
          </el-button>
    ...
    <div v-if="showOrdDtl" style="height:600px;padding:40px;width:100%">
      <el-row :gutter="20" style="line-height:40px;font-size:12px">
        <el-col :span="8">
          <el-button type="success" @click="showOrdDtl=false">
            返回列表
          </el-button>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20" style="line-height:40px">
        <el-col :span="24">
          <el-slider v-model="ordDtl.status" :marks="ordMarks" max="51" min="10" />
        </el-col>
      </el-row>
      <el-row :gutter="20" style="padding-top:70px;height:400px">
        <el-table :data="ordDtl.supplierList[0].dtlList" style="width: 100%; margin-bottom: 20px;" border>
